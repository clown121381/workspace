...
<%
	//查询所有
	SqlSession sess = Mybatis_Util.getSqlSession(true);
	MessageMapper m = sess.getMapper(MessageMapper.class);
	List<Message> li = m.findAllMessage();
%>    
<body>
<div id="wrapper">
        <div id="header">
		...
		<div id="mainWrapper">
               <div id="content" class="content-wide">
 			   <form action="/NoteBook/SelectServlet" method="post" >
	...
	<% for(Message mess : li) {%>
               <div class="textbox">
								...
								<div class="textbox-label">[标题 :<%=mess.getTitle() %>][留言者:<%=mess.getAuthor() %> ][留言日期:<%=mess.getAdd_date().substring(0,10) %> ]</div>
								</div>
