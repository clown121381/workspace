...
<TABLE cellSpacing=0 cellPadding=0 width=748 border=0 height="612">
  ...
  <TR>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <p align="center">&nbsp;</p>
    <form method="POST" action="/SeaFoodSuperMarket/AddVendor">
      ...
      <p align="center"><b><font color="#993333">&nbsp;&nbsp; Vendor Name:</font></b><input type="text" name="T1" size="20"></p>
      <p align="center"><b><font color="#993333">Vendor Address</font></b><font color="#993333"><b>:<input type="text" name="T2" size="20"></b></font></p>
      <p align="center"><b><font color="#993333">&nbsp;&nbsp;&nbsp; Vendor Phone</font></b><font color="#993333"><b>:<input type="text" name="T3" size="20"></b></font></p>
      <p align="center"><b><font color="#993333">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      Vendor FAX</font></b><font color="#993333"><b>:<input type="text" name="T4" size="20"></b></font></p>
      <p align="center"><font color="#993333"><b>&nbsp;&nbsp; Contact Person:<input type="text" name="T5" size="20"></b></font></p>
