...
<TABLE cellSpacing=0 cellPadding=0 width=748 border=0 height="537">
  ...
  <TR>
    <TD vAlign=middle width=181 height="47" bgcolor="#FDCC64" bordercolor="#993333" bordercolorlight="#800000">
      <p align="left"><b><font color="#993333">&nbsp;&nbsp; Income management</font></b>
    </TD>
    ...
    <div align="center">
      ...
      <table border="1" width="80%" bordercolor="#800000">
        ...
        <%
        	Map<String,String> map =(Map<String ,String>) request.getAttribute("dept_map");
        	List<Table_Income> in  = (List<Table_Income>)request.getAttribute("income_li");
        %>
       <%for(int i = 0;i < in.size(); i ++) { %>
 	        <tr>
	          <td width="19%" align="center"><font color="#993333"><%=map.get(in.get(i).getDept_id().toString()) %></font></td>
	          <td width="20%" align="center"><font color="#993333"><%=in.get(i).getBusiness_date() %></font></td>
	          <td width="20%" align="center"><font color="#993333"><%=in.get(i).getLst_mod_timestemp() %></font></td>
	          <td width="20%" align="center"><font color="#993333"><%=in.get(i).getDaily_income() %>$</font></td>
	          <td width="34%" align="center"><a href="/SeaFoodSuperMarket/FindIncome?income_id=<%=in.get(i).getIncome_id() %>"><img border="0" src="/SeaFoodSuperMarket/view/images1/depart1.gif" width="43" height="23"></a></td>
	        </tr>
		<%} %>
      </table>
      </center>
  ...
  <TR>
    <TD vAlign=middle width=181 height="47" bgcolor="#FDCC64" bordercolor="#993333" bordercolorlight="#800000">
      <p align="left"><b><font color="#993333">&nbsp;&nbsp; Dept management</font></b>
    </TD>
  </TR>
  <TR>
    <TD vAlign=middle width=181 height="47" bgcolor="#FDCC64" bordercolor="#993333" bordercolorlight="#800000">
  ...
  <TR>
    ...
    <p align="left"><b><font color="#993333">&nbsp;&nbsp; Vendor management</font></b>
    </TD>
  </TR>
  <TR>
    <TD vAlign=middle width=181 height="48" bgcolor="#FDCC64" bordercolor="#993333" bordercolorlight="#800000">
    <p align="left"><b><font color="#993333">&nbsp;&nbsp; Bill management</font></b>
    </TD>
  </TR>
  <TR>
    <TD vAlign=middle width=181 height="48" bgcolor="#FDCC64" bordercolor="#993333" bordercolorlight="#800000">
    <p align="left"><b><font color="#993333">&nbsp;&nbsp; Bill Payment</font></b>
    </TD>
  </TR>
  <TR>
    <TD vAlign=middle width=181 height="48" bgcolor="#FDCC64" bordercolor="#993333" bordercolorlight="#800000">
    <p align="left"><b><font color="#993333">&nbsp;&nbsp; Backup</font></b>
    </TD>
  </TR>
  <TR>
    <TD vAlign=bottom width=746 height="1" colspan="2">
      <form method="POST" action="/SeaFoodSuperMarket/FindAllDepts">
