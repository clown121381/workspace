...
<TABLE cellSpacing=0 cellPadding=0 width=748 border=0 height="574">
  ...
  <TR>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <p align="center">&nbsp;</p>
    <form method="POST" action="/SeaFoodSuperMarket/UpdateADept?dept_id=${dept.getDept_id() }">
      ...
      <p align="center"><b><font color="#993333">Department Name:</font></b><input type="text" name="T1" size="20" value="${dept.getDept_name() }"></p>
      <p align="center"><font color="#993333"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      Description:<input type="text" name="T2" size="20" value="${dept.getDept_description() }"></b></font></p>
