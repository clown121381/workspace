...
<TABLE cellSpacing=0 cellPadding=0 width=748 border=0 height="583">
  <TBODY>
  <TR>
    <TD vAlign=middle width=170 height="41" bgcolor="#FDCC64" bordercolor="#993333" bordercolorlight="#800000" align="left">
      <p><b><font color="#993333" size="3">&nbsp;&nbsp; Income management</font></b>
    </TD>
    <TD vAlign=top width=567 height="291" rowspan="7">
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <p align="center">&nbsp;</p>
    <form method="POST" action="/SeaFoodSuperMarket/FindAVendor">
      ...
      Vendor Name:</font></b><input type="text" name="T1" size="20"></p>
  ...
  <TR>
    <TD vAlign=middle width=170 height="41" bgcolor="#FDCC64" bordercolor="#993333" bordercolorlight="#800000" align="left">
    <p><b><font color="#993333" size="3">&nbsp;&nbsp; Report management</font></b>
    </TD>
  </TR>
  <TR>
    <TD vAlign=middle width=170 height="42" bgcolor="#FDCC64" bordercolor="#993333" bordercolorlight="#800000" align="left">
  ...
  <TR>
    <TD vAlign=middle width=170 height="42" bgcolor="#FDCC64" align="left">
