...
<TABLE cellSpacing=0 cellPadding=0 width=748 border=0 height="580">
  ...
  <TR>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <p align="center">&nbsp;</p>
    <form method="POST" action="/SeaFoodSuperMarket/AddADept">
      ...
      <p align="center"><b><font color="#993333">Department Name:</font></b><input type="text" name="T1" size="20"></p>
      <p align="center"><font color="#993333"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      Description:<input type="text" name="T2" size="20"></b></font></p>
