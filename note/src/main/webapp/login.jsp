...
<div align="center"><font color="#FFFFFF"><strong>请先登陆</strong></font></div></td>
  ...
  <tr> 
    <td bgcolor="#FFFFFF">
<form name="form1" method="post" action="/note/login">
<table width="100%" border="0" align="center">
          <tr> 
<td colspan="2" align="center">
<b>帐户:</b>
            <input name="username" type="text" id="yhm" value="" size="12"></td>
          </tr>
          <tr> 
<td colspan="2" align="center">
<b>密码:</b>
            <input name="userpass" type="password" id="yhmm" value="" size="12"></td>
          </tr>
